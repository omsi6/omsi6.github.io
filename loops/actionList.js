...
const allActions = {
    // town 1
    "Wander": { varName: "Wander", create() { return new Wander() } },
    "Smash Pots": { varName: "Pots", create() { return new SmashPots() } },
    "Pick Locks": { varName: "Locks", create() { return new PickLocks() } },
    "Buy Glasses": { varName: "Glasses", create() { return new BuyGlasses() } },
    "Buy Mana": { varName: "Gold", create() { return new BuyMana() } },
    "Meet People": { varName: "Met", create() { return new MeetPeople() } },
    "Train Strength": { varName: "trStr", create() { return new TrainStrength() } },
    "Short Quest": { varName: "SQuests", create() { return new ShortQuest() } },
    "Investigate": { varName: "Secrets", create() { return new Investigate() } },
    "Long Quest": { varName: "LQuests", create() { return new LongQuest() } },
    "Warrior Lessons": { varName: "trCombat", create() { return new WarriorLessons() } },
    "Mage Lessons": { varName: "trMagic", create() { return new MageLessons() } },
    "Throw Party": { varName: "Party", create() { return new ThrowParty() } },
    "Heal The Sick": { varName: "Heal", create() { return new HealTheSick() } },
    "Fight Monsters": { varName: "Fight", create() { return new FightMonsters() } },
    "Small Dungeon": { varName: "SDungeon", create() { return new SmallDungeon() } },
    "Buy Supplies": { varName: "Supplies", create() { return new BuySupplies() } },
    "Haggle": { varName: "Haggle", create() { return new Haggle() } },
    "Start Journey": { varName: "Journey", create() { return new StartJourney() } },
    "Open Rift": { varName: "OpenRift", create() { return new OpenRift() } },
    // town 2
    "Explore Forest": { varName: "Forest", create() { return new ExploreForest() } },
    "Wild Mana": { varName: "WildMana", create() { return new WildMana() } },
    "Gather Herbs": { varName: "Herbs", create() { return new GatherHerbs() } },
    "Hunt": { varName: "Hunt", create() { return new Hunt() } },
    "Sit By Waterfall": { varName: "Waterfall", create() { return new SitByWaterfall() } },
    "Old Shortcut": { varName: "Shortcut", create() { return new OldShortcut() } },
    "Talk To Hermit": { varName: "Hermit", create() { return new TalkToHermit() } },
    "Practical Magic": { varName: "trPractical", create() { return new PracticalMagic() } },
    "Learn Alchemy": { varName: "learnAlchemy", create() { return new LearnAlchemy() } },
    "Brew Potions": { varName: "Potions", create() { return new BrewPotions() } },
    "Train Dexterity": { varName: "trDex", create() { return new TrainDexterity() } },
    "Train Speed": { varName: "trSpd", create() { return new TrainSpeed() } },
    "Follow Flowers": { varName: "Flowers", create() { return new FollowFlowers() } },
    "Bird Watching": { varName: "BirdWatching", create() { return new BirdWatching() } },
    "Clear Thicket": { varName: "Thicket", create() { return new ClearThicket() } },
    "Talk To Witch": { varName: "Witch", create() { return new TalkToWitch() } },
    "Dark Magic": { varName: "trDark", create() { return new DarkMagic() } },
    "Dark Ritual": { varName: "DarkRitual", create() { return new DarkRitual() } },
    "Continue On": { varName: "Continue", create() { return new ContinueOn() } },
    // town 3    
    "Explore City": { varName: "City", create() { return new ExploreCity() } },
    "Gamble": { varName: "Gamble", create() { return new Gamble() } },
    "Get Drunk": { varName: "Drunk", create() { return new GetDrunk() } },
    "Purchase Mana": { varName: "Gold2", create() { return new PurchaseMana() } },
    "Sell Potions": { varName: "SellPotions", create() { return new SellPotions() } },
    "Read Books": { varName: "ReadBooks", create() { return new ReadBooks() } },
    "Adventure Guild": { varName: "AdvGuild", create() { return new JoinAdvGuild() } }, // JoinAdvGuild, not a AdventureGuild
    "Gather Team": { varName: "GatherTeam", create() { return new GatherTeam() } },
    "Large Dungeon": { varName: "LDungeon", create() { return new LargeDungeon() } },
    "Crafting Guild": { varName: "CraftGuild", create() { return new CraftingGuild() } },
    "Craft Armor": { varName: "CraftArmor", create() { return new CraftArmor() } },
    "Apprentice": { varName: "Apprentice", create() { return new Apprentice() } },
    "Mason": { varName: "Mason", create() { return new Mason() } },
    "Architect": { varName: "Architect", create() { return new Architect() } },
    "Buy Pickaxe": { varName: "Pickaxe", create() { return new BuyPickaxe() } },
    "Start Trek": { varName: "StartTrek", create() { return new StartTrek() } },
    // town 4    
    "Climb Mountain": { varName: "Mountain", create() { return new ClimbMountain() } },
    "Mana Geyser": { varName: "Geysers", create() { return new ManaGeyser() } },
    "Decipher Runes": { varName: "Runes", create() { return new DecipherRunes() } },
    "Chronomancy": { varName: "trChronomancy", create() { return new Chronomancy() } },
    "Looping Potion": { varName: "LoopingPotion", create() { return new LoopingPotion() } },
    "Pyromancy": { varName: "trPyromancy", create() { return new Pyromancy() } },
    "Explore Cavern": { varName: "Cavern", create() { return new ExploreCavern() } },
    "Mine Soulstones": { varName: "MineSoulstones", create() { return new MineSoulstones() } },
    "Hunt Trolls": { varName: "HuntTrolls", create() { return new HuntTrolls() } },
    "Check Walls": { varName: "Illusions", create() { return new CheckWalls() } },
    "Take Artifacts": { varName: "Artifacts", create() { return new TakeArtifacts() } },
    "Imbue Mind": { varName: "ImbueMind", create() { return new ImbueMind() } },
    "Face Judgement": { varName: "FaceJudgement", create() { return new FaceJudgement() } },
    // town 5
    // "Look Around": { varName: "LookAround", create() { return new LookAround() } },
    "Great Feast": { varName: "GreatFeast", create() { return new GreatFeast() } },
    "Fall From Grace": { varName: "FallFromGrace", create() { return new FallFromGrace() } },
    // town 6
    // "Survey Area": { varName: "SurveyArea", create() { return new SurveyArea() } },
};
